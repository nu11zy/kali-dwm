...
static const char *logoffcmd[]  = { "xfce4-session-logout", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Escape,     spawn,                  {.v = logoffcmd } },
	...
	{ MODKEY,                       XK_e,          setlayout,              {.v = &layouts2[0]} },
